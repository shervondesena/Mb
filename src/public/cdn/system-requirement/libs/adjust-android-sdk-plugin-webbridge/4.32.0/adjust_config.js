...
AdjustConfig.prototype.setEventSuccessCallback = function (callback) {
  if (typeof callback === "string" || callback instanceof String) {
    ...
    this.eventSuccessCallbackName =
      "Adjust.getConfig().adjust_eventSuccessCallback";
...
AdjustConfig.prototype.setEventFailureCallback = function (callback) {
  if (typeof callback === "string" || callback instanceof String) {
    ...
    this.eventFailureCallbackName =
      "Adjust.getConfig().adjust_eventFailureCallback";
...
AdjustConfig.prototype.setSessionSuccessCallback = function (callback) {
  if (typeof callback === "string" || callback instanceof String) {
    ...
    this.sessionSuccessCallbackName =
      "Adjust.getConfig().adjust_sessionSuccessCallback";
    this.sessionSuccessCallbackFunction = callback;
  }
};

AdjustConfig.prototype.adjust_sessionSuccessCallback = function (
  sessionSuccess
) {
...
AdjustConfig.prototype.setSessionFailureCallback = function (callback) {
  if (typeof callback === "string" || callback instanceof String) {
    ...
    this.sessionFailureCallbackName =
      "Adjust.getConfig().adjust_sessionFailureCallback";
    this.sessionFailureCallbackFunction = callback;
  }
};

AdjustConfig.prototype.adjust_sessionFailureCallback = function (
  sessionFailure
) {
...
AdjustConfig.prototype.setDeferredDeeplinkCallback = function (callback) {
  if (typeof callback === "string" || callback instanceof String) {
    ...
    this.deferredDeeplinkCallbackName =
      "Adjust.getConfig().adjust_deferredDeeplinkCallback";
...
AdjustConfig.prototype.setAppSecret = function (
  secretId,
  info1,
  info2,
  info3,
...
AdjustConfig.prototype.setReadMobileEquipmentIdentity = function (
  readMobileEquipmentIdentity
) {};

AdjustConfig.prototype.setFbPixelDefaultEventToken = function (
  fbPixelDefaultEventToken
) {
  this.fbPixelDefaultEventToken = fbPixelDefaultEventToken;
};

AdjustConfig.prototype.addFbPixelMapping = function (
  fbEventNameKey,
  adjEventTokenValue
) {
