...
function initCardResultDragable() {
    ...
    box.addEventListener('touchmove', function (e) {
        ...
        box.style.left = (touchLocation.pageX - 57) + 'px';
...
function initDefaultSetting() {
    ...
    if (localStorageAction("get", PREFIX_GAME + "SETTING_ALLOW_SCROLL_PAGE", null) === null) localStorageAction("set", PREFIX_GAME + PREFIX_GAME + "SETTING_ALLOW_SCROLL_PAGE", false);
}
...
function switchSettingAction(action, node) {
    ...
    switch (action) {
        ...
        case "audio_livestream":
            ...
            localStorageAction("set", PREFIX_GAME + "SETTING_AUDIO_LIVESTREAM", currentValue);
            clickAudioSound();
            break;
        case "allow_scroll":
